...
itens_ref.set({
    '01': {
        ...
        'Como pode ser usada': 'Espada bate nos números 1, 3, 5, 7, 9 com naipe de espada.',
        'dano': 2
    },
    '02': {
        'nome': 'Espada de ferro fraca (SM0)',
        'descricao': 'Versão mais fraca da espada de ferro da Semana 0.',
        'Como pode ser usada': 'Bate nos números 3, 5, 7 com naipe de espada.',
        'dano': 1
    },
    '03': {
    ...
    '04': {
        ...
        'descricao': 'Versão mais fraca da espada de ferro da Semana 1.',
        'Como pode ser usada': 'Bate nos números 3, 5, 7 com naipe de espada.',
        'dano': 1
    },
    '05': {
        'nome': 'Criação de Grupo',
        'descricao': 'Permite criar um grupo de jogadores para missões.',
    ...
    '09': {
        'nome': 'Bola de fogo',
        'descricao': 'Magia de ataque em área.',
    ...
    '10': {
        ...
        'descricao': 'Figura mística que afasta as sombras.',
    ...
    '11': {
        ...
        'Como pode ser usada': 'Bate nos números 2, 4, 6, 8.',
        'dano': 2
    },
    '12': {
        'nome': 'Bolsa de moeda mercador (SM3)',
        'descricao': 'Bolsa especial Quando derrota um inimigo, você terá 50% de chance obter uma moeda.',
        'Como pode ser usada': 'Você usará no cobate quando derrotar 1 inimigo terá pode obeter uma moeda.',
        'dano': 0
    }
})
...
missoes_ref.set({
    ...
    'm2': {
        ...
        'descricao': 'Chefe inicial da campanha',
        'completada_por': ['001', '003', '004', '005', '006', '007', '008', '009', '011', '012', '013', '014', '015', '016', '017', '018', '019', '020', '021', '022', '023', '024'],
        'status': 'completa'
    },
    'm3': {
...
for id_jogador, info in dados.items():
    ...
    # Pega inventário (se for None, vira lista vazia)
    inventario = info.get('Inventario') or []
    #limpa lista de itens formatados para não repetir
    itens_formatadas = ""
    if not inventario: itens_formatadas = "Vazio"
    else:
      for y in inventario:
          if y == "Vazio": #caso seja vazio, ele já encerra
    ...
    #tirando a virgula final para padronização, pegando tudo menos os 2 ultimos CARACTERES/LETRAS
    if itens_formatadas != "Vazio": itens_formatadas= itens_formatadas[:-2]


    print(f"🔵 Itens : {itens_formatadas}")
    print(f"🔵 Classes : {classes_formatadas}")
